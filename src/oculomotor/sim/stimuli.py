...
def build_visual_flags(
    ...
    """Convert VisualFlagsSegments to per-eye (scene_present_L, scene_present_R,
    ...
    return _fit1d(spL, total_T), _fit1d(spR, total_T), _fit1d(tpL, total_T), _fit1d(tpR, total_T)
