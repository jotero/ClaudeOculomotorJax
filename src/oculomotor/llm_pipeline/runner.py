...
def _build_params(patient: Patient):
    ...
    params = with_brain(params,
        ...
        K_verg_fast     = patient.K_verg_fast,
        tau_verg_fast   = patient.tau_verg_fast,
        K_verg_slow     = patient.K_verg_slow,
        tau_verg_slow   = patient.tau_verg_slow,
